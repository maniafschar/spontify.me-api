...
public class MatchDayService {
	...
	public String retrieveMatchDays(final int pastMatches, final int futureMatches, final List<Integer> teamIds) {
		...
		s.insert(0, "<style>header{font-size:0.7em;}span{padding-top:1em;display:inline-block;width:100%;}home,away{width:42%;display:inline-block;white-space:nowrap;text-overflow:ellipsis;overflow:hidden;}home{text-align:right;}away{text-align:left;}goals{width:8%;display:inline-block;text-align:center;overflow:hidden;}goals.sep::before{content:':';position:absolute;margin-left:-3.5%;}</style><matchDays style=\"text-align:center;display:inline-block;\">");
		s.append("</matchDays>");
		return s.toString();
	}
