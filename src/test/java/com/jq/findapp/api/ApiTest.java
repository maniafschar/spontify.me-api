...
public class ApiTest {
	...
	public void paypal() throws Exception {
		...
		// when
		final String accessToken = n.get("access_token").asText();

		// then
		assertEquals("A21AAIvYuE4je0EzM2m3pNgDQZl2EqeMtrLxleSuAkk7eOwSWiX4tJsesJYJLFW0en2NMthOuJ7kh3rKo9BU02hOFB9wNqp_Q",
				accessToken);
	}
	...
	public void createLocation() throws Exception {
		// given
		final String body = "{\"classname\":\"Location\",\"values\":{\"name\":\"test\",\"address\":\"83700 Rottach-Egern\",\"category\":\"1\",\"latitude\":47.666,\"longitude\":11.777}}";
		final String path = "db/one";
